...
public class DivId {
    ...
    private DataTypeDefn__ dataTypeDefn;
    @JsonProperty("dataTypeDefnParameters")
    private DataTypeDefnParameters__ dataTypeDefnParameters;
    ...
    @JsonProperty("dataTypeDefn")
    public DataTypeDefn__ getDataTypeDefn() {
        return dataTypeDefn;
    }

    @JsonProperty("dataTypeDefn")
    public void setDataTypeDefn(DataTypeDefn__ dataTypeDefn) {
        this.dataTypeDefn = dataTypeDefn;
    }

    @JsonProperty("dataTypeDefnParameters")
    public DataTypeDefnParameters__ getDataTypeDefnParameters() {
        return dataTypeDefnParameters;
    }

    @JsonProperty("dataTypeDefnParameters")
    public void setDataTypeDefnParameters(DataTypeDefnParameters__ dataTypeDefnParameters) {
