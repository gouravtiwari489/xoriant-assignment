...
public class DeptId {
    ...
    private DataTypeDefn_           dataTypeDefn;
    @JsonProperty("dataTypeDefnParameters")
    private DataTypeDefnParameters_ dataTypeDefnParameters;
    ...
    @JsonProperty("dataTypeDefn")
    public DataTypeDefn_ getDataTypeDefn() {
        return dataTypeDefn;
    }

    @JsonProperty("dataTypeDefn")
    public void setDataTypeDefn(DataTypeDefn_ dataTypeDefn) {
        this.dataTypeDefn = dataTypeDefn;
    }

    @JsonProperty("dataTypeDefnParameters")
    public DataTypeDefnParameters_ getDataTypeDefnParameters() {
        return dataTypeDefnParameters;
    }

    @JsonProperty("dataTypeDefnParameters")
    public void setDataTypeDefnParameters(DataTypeDefnParameters_ dataTypeDefnParameters) {
